...
bool DepthMapsData::InitDepthMap(DepthData& depthData)
{
	...
	TriangulatePoints2DepthMap(image, scene.pointcloud, depthData.points, depthData.depthMap, depthData.normalMap, depthData.dMin, depthData.dMax, OPTDENSE::bAddCorners, scene.sparseContraints);
	depthData.dMin *= 0.9f;
	depthData.dMax *= 1.1f;
