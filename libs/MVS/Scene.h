...
namespace MVS
{
	...
	public:
		...
		SparseConstraints sparseContraints; // Triangulation contraints to apply during depthmap surface initialization
	public:
		...
		bool LoadSparseContraints(const String &constraintsFile);
	};
	/*----------------------------------------------------------------*/
